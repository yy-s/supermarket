<template>
		<section>
				...
				<div class="search">
						<Button type="success" to="/v/addOrder">添加订单</Button>
						<p class="searchText">
				...
				<Modal
						...
						<Form :model="formItem" :label-width="80">
								<FormItem label="采购单名称">
										<Input v-model="formItem1.orderName" placeholder="请输入订单名称"></Input>
								</FormItem>
								<FormItem label="采购单编号">
										<Input v-model="formItem1.orderID" placeholder="请输入订单编号"></Input>
								</FormItem>
								<FormItem label="采购日期">
										<Input v-model="formItem1.CGDate" placeholder="请输入采购日期"></Input>
								</FormItem>
								<FormItem label="出单人员">
										<Input v-model="formItem1.CDPerson" placeholder="请输入出单人员"></Input>
								</FormItem>
								<FormItem label="审核人员">
										<Input v-model="formItem1.SHPerson" placeholder="请输入审核人员"></Input>
								</FormItem>
						</Form>
				</Modal>
		</section>
            ...
            getPurchase(params) {
                if (!params.row.purchaseID) {
                    ...
                    let params = {
                        'page': this.page,
                        'pageSize': 10,
                        'searchid': params.row.purchaseID,
                        'by': this.By
                    }

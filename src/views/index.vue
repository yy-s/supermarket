<template>
		<div class="layout">
				<Layout>
						...
						<Layout class="main">
								<Sider ref="side" hide-trigger class="slide">
										<Menu active-name="1-2" theme="light" width="auto" :open-names="['1']" v-if="isShow">
												<Submenu name="1">
														<template slot="title">
												...
												<Submenu name="2">
														...
														<router-link to="purchase">
																<MenuItem name="2-1">采购记录</MenuItem>
														</router-link>
												...
												<Submenu name="3">
														...
														<router-link to="supplier">
																<MenuItem name="3-1">供应厂商</MenuItem>
														</router-link>
												</Submenu>
												<Submenu name="4">
														<template slot="title">
		...
		export default {
				data() {
						return {
								...
								isShow: localStorage.getItem('type') === '1'
						}
				},
				methods: {
						loginout() {
...
<style lang="less" scoped>
		...
		.ivu-layout.ivu-layout-has-sider .slide[data-v-a83bd3b0] {
